...
| 05 | Trainer assigned-session projection (R-1) — **delivered**; a schedule/date projection over the same class-session records is **not** delivered | Not captured — **required immediately** | — (function folded into `/trainer`) | **Operator decision required** — see §7.3 |
