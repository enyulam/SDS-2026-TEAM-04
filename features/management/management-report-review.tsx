...
> = {
  ...
  // one slot: Overview took the success tick and Strengths -- the panel
  // that is by definition positive demonstrated capability -- rendered in
  // the WARNING tone. Both independent reviewers flagged it. A positional
  // carry-over is a relabelling shim in the presentation layer, which is
  // what OD-4 prohibits. Assigned below from what each panel MEANS.
