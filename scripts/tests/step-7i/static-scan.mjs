...
// ---------------------------------------------------------------------
{
  ...
  if (all.length !== 7) fail('T7I-73', `${all.length} migration files exist, expected 7`) // 5 through Step 7I + the B2 assessment migration + the B2.1 correction-tracking migration
