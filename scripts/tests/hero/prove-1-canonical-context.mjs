...
check(
  emittedLegs(out, "P1"),
  `the SQL suite ACTUALLY RAN and emitted its own P1- legs (${out.trim().length} chars of output) -- without this, the assertions below are satisfied by an unreachable database`,
);
