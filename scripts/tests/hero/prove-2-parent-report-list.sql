...
BEGIN
  ...
  IF v_n = 1 AND v_listed = 75 THEN
    v_pass := v_pass + 1;
    RAISE NOTICE 'PASS P2-6 -- 75 functions and the context return set is still exactly 7. This is the project''s SINGLE global function ratchet, and the twelve added since it last read 62 are attributed one by one in the comment above (P2-11, P2-9, P2-16, P2-19, P2-20, P2-12, P2-13, P2-14, P2-22, P2-18)';
  ELSE
    v_fail := v_fail + 1;
    RAISE WARNING 'FAIL P2-6 -- % function(s) in public (expected 75) and context field-set match = %', v_listed, v_n;
  END IF;
