...
check(
  emittedLegs(out, "P9"),
  `the SQL suite ACTUALLY RAN and emitted its own P9- legs (${out.trim().length} chars of output) -- without this, the assertions below are satisfied by an unreachable database`,
);
