...
check(
  emittedLegs(out, "P2a"),
  `the SQL suite ACTUALLY RAN and emitted its own P2a- legs (${out.trim().length} chars of output) -- without this, the assertions below are satisfied by an unreachable database`,
);
