...
// ZERO enums, so movement in either direction is a finding.
  ...
  `nothing this phase depends on was REMOVED: tables >= 29 | 12 enums | 30 policies (measured ${tables} | ${enums} | ${policies}). Reported, not pinned: ${migrations} migrations, ${functions} functions, registry ${registry}`,
);
