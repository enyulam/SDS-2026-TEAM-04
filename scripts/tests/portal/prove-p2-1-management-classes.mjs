 ...
 */
check(
  /all 35 portal routes derived from app\/\*\*\/page\.tsx carry an expectation/.test(nav.stdout ?? ""),
  "P21a-14 …and its census READ 35 routes from the app tree (16 + `26` at P2-2 + `27` at P2-3 + `13` at P2-4 + `25` at P2-5 + `14` at P2-6 + `11` at P2-7 + `17` at P2-8 + `23` at P2-10 + `24` at P2-11 + `18` at P2-9 + `15` at P2-15 + `16` at P2-16 + `02` at P2-17 + `01` at P2-19 + `04` at P2-20 + `20` at P2-12 + `21` at P2-13 + `22` at P2-14 + `30` at P2-22) -- the ratchet SAW the new route rather than passing over a list that never mentioned it",
);
