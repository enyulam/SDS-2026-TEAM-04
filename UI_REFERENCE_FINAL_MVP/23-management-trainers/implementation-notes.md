# 23 - Management Trainers - implementation notes
...
- **GC-12 — Trainer status "On leave". centre_memberships.status is EXACTLY pending / active / deactivated. A third value must never be created from a frame. DO NOT BUILD.**
