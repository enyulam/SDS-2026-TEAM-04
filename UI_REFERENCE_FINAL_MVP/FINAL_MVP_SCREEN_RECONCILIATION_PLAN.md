...
|---|---|---|
| *What should this look like?* (layout, spacing, geometry, control placement) | **Visual** | The **frozen `reference.png` wins** — over `screen.md`, over the HTML, over the implementation |
