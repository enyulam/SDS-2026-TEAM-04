...
**Precedence (highest first):** Specification v3 → ratified amendments (Amendment 001, then Amendment 002, then Amendment 003, then **Amendment 004** for the clauses each names) → this `CLAUDE.md` → Implementation Plan → **Figma Design 2** (visual/interaction reference) → `docs/progress/STATUS.md` → `docs/progress/BUILD_NOTES.md` → temporary migration tracker.
